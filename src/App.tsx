...
const prices = [
  {
    ...
    description:
      "Разбор задачи, определение потребностей и предварительные рекомендации",
    price: "от 2 000 ₽",
  },
  {
    service: "ИТ-аудит инфраструктуры",
    description:
      "Проверка серверов, рабочих мест, сетей и систем хранения данных",
    price: "от 15 000 ₽",
  },
  {
  ...
  },
  {
    ...
    description:
      "Обновление оборудования, настройка систем и повышение надежности",
    price: "от 30 000 ₽",
  },
  {
    service: "Техническое сопровождение",
    description:
      "Регулярная поддержка, обслуживание и решение технических вопросов",
    price: "от 20 000 ₽",
  },
];
    ...
    <div className="site">
      <header className={isHeaderVisible ? "header" : "header header-hidden"}>
        <a href="#" className="logo" onClick={closeMenu}>
          <img src="/logo-kompas.jpg" alt="Логотип компании Компас" />
          <span>Компас</span>
        </a>
      ...
      <main>
        <section className="hero">
          <div className="hero-content">
            ...
            <p className="hero-text">
              КОМПАС помогает компаниям проектировать, внедрять,
              модернизировать и сопровождать ИТ-инфраструктуру. Мы создаем
              решения, которые повышают надежность, безопасность и эффективность
              бизнеса.
            </p>
        ...
        <section id="about" className="section about">
          <div>
            ...
            <p>
              ...
              ИТ-решения: от обследования текущей среды и аудита до
              проектирования, внедрения, модернизации и дальнейшего
        ...
        <section id="prices" className="section">
          ...
          <p className="price-note">
            ...
            и требований заказчика. Оставьте заявку, и мы подготовим
        ...
        <section id="partners" className="section about">
          <div>
            ...
            <p>
              ...
              заказчиков надежные технологии в области информационной
              безопасности, серверной инфраструктуры, программного обеспечения и
